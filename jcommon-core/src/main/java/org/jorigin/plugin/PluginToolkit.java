...
public class PluginToolkit {
	...
	/**
	 * The list of plugins loaded by the toolkit.
	 * <p>
	 * This list is filled when {@link #loadPlugins()} is called.
	 */
	private ArrayList<IPlugin> plugins         = null;

	/**
	 * The list of directories where the toolkit will search for plugins.
	 * <p>
	 * This list is filled when {@link #addPluginDir(String)} or {@link #addPluginDir(File)} is called.
	 */
	private ArrayList<File> pluginDirs         = null;

	/**
	 * The core package of the plugins.
	 * <p>
	 * This package is used to filter the plugins found in the plugin directories.
	 * <p>
	 ...
	 * <p>
	 * This value is used to track the progress of the plugin loading task.
	 * It is incremented each time a plugin is loaded.
	 */

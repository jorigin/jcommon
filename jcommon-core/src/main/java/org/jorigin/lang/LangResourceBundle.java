...
public class LangResourceBundle extends ResourceBundle{
	...
	/**
	 * The static instance of the {@link LangResourceBundle} class. This instance is used to access the lang resources.
	 */
	 ...
	 * This constructor is private to ensure that the class is a singleton and that the static instance is used.
	 */
	private LangResourceBundle() {
		// Private constructor to prevent instantiation
	}
	...
	/**
	 * Initialize the underlying {LangResourceBundle lang resource bundle}.
	 * @param baseName The path to the lang resource bundle content
	...
	/**
	 * Initialize the underlying {LangResourceBundle lang resource bundle} with the default path and locale.
	 */

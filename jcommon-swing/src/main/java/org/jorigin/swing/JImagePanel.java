...
public class JImagePanel extends JPanel {
	...
	/**
	 * The {@link BufferedImage image} displayed by this panel.
	 * This image can be set using {@link #setImage(BufferedImage)} method.
	 */
	private BufferedImage image = null;

	/**
	 * The layers of {@link JImageFeature image features} attached to this panel.
	 * Each layer is identified by a {@link String name} and contains a list of {@link JImageFeature image features}.
	 * The layers can be set using {@link #setImageFeatures(String, List)} method.
	 */
	private Map<String, List<JImageFeature>> layers;

	/**
	 * The visibility of each layer of {@link JImageFeature image features} attached to this panel.
	 */
	private Map<String, Boolean> layersVisibility;

	/**
	 * The scale factor applied to the image displayed by this panel.
	 * This scale can be set using {@link #setScale(double)} method.
	 */
	private double scale = 1.0f;

	/**
	 * The {@link RenderingHints rendering hints} used by this panel.
	 * If this property is set to <code>null</code>, then default rendering hints are used.
	 * This property can be set using {@link #setRenderingHints(RenderingHints)} method.
	 */
	private RenderingHints renderingHints = null;

	/**
	 * The {@link AffineTransform transformation} applied to the image displayed by this panel.
	 * This transformation can be used to apply translation and scaling to the image.
	 * It can be set using {@link #setTranslation(Point2D)} and {@link #setScale(double)} methods.
	 */
	private AffineTransform transform = null;

	/**
	 * The selection shape used to select features on the image.
	 * This shape can be set using {@link #setSelectionShape(Shape)} method.
	 * If this property is set to <code>null</code>, then no selection shape is used.
	 */
	private Shape selectionShape = null;

	/**
	 * The {@link Stroke stroke} used to draw the selection shape.
	 * This stroke can be set using {@link #setSelectionShapeStroke(Stroke)} method.
	 * If this property is set to <code>null</code>, then a default stroke is used.
	 */
	private Stroke selectionShapeStroke = null;

	/**	
	 * The selection mode used by the panel. This can be one of:
	 * <ul>
	...
	/**	
	 * The mouse button active on the panel. This value is a bitwise OR of the {@link InputEvent#BUTTON1_DOWN_MASK}, {@link InputEvent#BUTTON2_DOWN_MASK} and {@link InputEvent#BUTTON3_DOWN_MASK} values.
	 * This value is updated when a mouse button is pressed or released.
	 */
	private int mouseButtonActive = 0;

	/**
	 * The last cursor position on the panel. This position is updated when the mouse is moved or dragged.
	 * It is used to compute the translation of the image when the mouse is dragged.
	 */
	...
	/**
	 * If <code>true</code>, the panel will repaint itself every time a modification is made to the displayed object (image, features) or to the view (scale, translation, ...). 
	 * This mode is not convenient if many modification has to be made before a display refresh. 
	 * In this case, it is recommended to set this property to <code>false</code> and to call {@link #repaint()} when all modifications are done.
	 */
	private boolean autoRepaint = true;

	/**
	 * If <code>true</code>, the panel will fit the view when it is resized. 
	 * This means that the image will be scaled and translated to fit the panel size.
	 * @see #fit()
	 */
	private boolean autoFit     = false;

	/**
	 * A flag to indicate if the panel is currently painting. 
	 * This flag is set to <code>true</code> when the {@link #paintComponent(Graphics)} method is called and set to <code>false</code> when the painting is done.
	 */
	...
	/**
	 * Get the selection shape used by the panel.
	 * @return the selection shape used by the panel or <code>null</code> if no selection shape is used.
	 */
	...
	/**
	 * Set the selection shape used by the panel. 
	 * If the <code>shape</code> parameter is set to <code>null</code>, then no selection shape is used.
	 * @param shape the selection shape used by the panel.
